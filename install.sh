...
echo 'alias keypay="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/llino/keepayArk.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/llino/keepayArk.git'"
...
rm -rf "$HOME/.config/@keypay"
rm -rf "$HOME/.config/@keypay"
rm -rf "$HOME/.config/keypay-core"
